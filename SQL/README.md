...
# Background
Driven by quest to analyse data analyst job market more effectively, this project is born from desire to pin-point the top-paid and in-demand skills, streamlining others work to find optimal jobs.
...
# Tools I Used
For my deep dive in data analyst job market, I harnessed the power of several key tools:

- SQL: The backbone of my analysis, allowing me to query my database and unearth critical insights.
- POSTGRE SQL: The chosen Database management system, ideal for handling the data job analysis.
- Visual Studio Code: My go-to for databaseand executing SQL queries.
...
![Top Paying Roles](/SQL\0_Resources\Images\1_top_paying_roles.png)
...
![Top Paying Skills](/SQL\0_Resources\Images\2_top_paying_roles_skills.png)
...
[![SQL for Data Analytics](/SQL/0_Resources/Images/SQL-course.png)](https://youtu.be/7mz73uXD9DA?si=FH-Jycu31UGScO0O)
